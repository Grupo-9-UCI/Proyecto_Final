/* ---------------------------------------------------------------------------------------*/
/* Creación de esquema de BD "mimiciii"                                                   */
/* ---------------------------------------------------------------------------------------*/
CREATE SCHEMA IF NOT EXISTS mimiciii COLLATE utf8mb4_0900_ai_ci;
...
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "ADMISSIONS"                                                   */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\ADMISSIONS.csv' INTO TABLE ADMISSIONS
...
CREATE TABLE CALLOUT 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "CALLOUT"                                                      */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\CALLOUT.csv' INTO TABLE CALLOUT
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
   (@ROW_ID,@SUBJECT_ID,@HADM_ID,@SUBMIT_WARDID,@SUBMIT_CAREUNIT,@CURR_WARDID,@CURR_CAREUNIT,@CALLOUT_WARDID,@CALLOUT_SERVICE,@REQUEST_TELE,
    @REQUEST_RESP,@REQUEST_CDIFF,@REQUEST_MRSA,@REQUEST_VRE,@CALLOUT_STATUS,@CALLOUT_OUTCOME,@DISCHARGE_WARDID,@ACKNOWLEDGE_STATUS,@CREATETIME,
...
CREATE TABLE CAREGIVERS 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "CAREGIVERS"                                                   */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\CAREGIVERS.csv' INTO TABLE CAREGIVERS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE CHARTEVENTS (	-- rows=263201375
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "CHARTEEVENTS"                                                 */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\CHARTEVENTS.csv' INTO TABLE CHARTEVENTS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE CPTEVENTS 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "CPTEVENTS"                                                    */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\CPTEVENTS.csv' INTO TABLE CPTEVENTS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE D_CPT 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "D_CPT"                                                        */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\D_CPT.csv' INTO TABLE D_CPT
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE D_ICD_DIAGNOSES 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "D_ICD_DIAGNOSES"                                              */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\D_ICD_DIAGNOSES.csv' INTO TABLE D_ICD_DIAGNOSES
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE D_ICD_PROCEDURES 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "D_ICD_PROCEDURES"                                             */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\D_ICD_PROCEDURES.csv' INTO TABLE D_ICD_PROCEDURES
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
   (@ROW_ID,@ICD9_CODE,@SHORT_TITLE,@LONG_TITLE)
...
CREATE TABLE D_ITEMS 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "D_ITEMS"                                                      */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\D_ITEMS.csv' INTO TABLE D_ITEMS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE D_LABITEMS 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "D_LABITEMS"                                                   */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\D_LABITEMS.csv' INTO TABLE D_LABITEMS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE DATETIMEEVENTS 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "DATETIMEEVENTS"                                               */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\DATETIMEEVENTS.csv' INTO TABLE DATETIMEEVENTS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE DIAGNOSES_ICD 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "DIAGNOSES_ICD"                                                */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\DIAGNOSES_ICD.csv' INTO TABLE DIAGNOSES_ICD
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE DRGCODES 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "DRGCODES"                                                     */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\DRGCODES.csv' INTO TABLE DRGCODES
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE ICUSTAYS 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "ICUSTAYS"                                                     */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\ICUSTAYS.csv' INTO TABLE ICUSTAYS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE INPUTEVENTS_CV 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "INPUTEVENTS_CV"                                               */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\INPUTEVENTS_CV.csv' INTO TABLE INPUTEVENTS_CV
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE INPUTEVENTS_MV 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "INPUTEVENTS_MV"                                               */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\INPUTEVENTS_MV.csv' INTO TABLE INPUTEVENTS_MV
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
   (@ROW_ID,@SUBJECT_ID,@HADM_ID,@ICUSTAY_ID,@STARTTIME,@ENDTIME,@ITEMID,@AMOUNT,@AMOUNTUOM,@RATE,@RATEUOM,@STORETIME,@CGID,@ORDERID,
    @LINKORDERID,@ORDERCATEGORYNAME,@SECONDARYORDERCATEGORYNAME,@ORDERCOMPONENTTYPEDESCRIPTION,@ORDERCATEGORYDESCRIPTION,@PATIENTWEIGHT,
    @TOTALAMOUNT,@TOTALAMOUNTUOM,@ISOPENBAG,@CONTINUEINNEXTDEPT,@CANCELREASON,@STATUSDESCRIPTION,@COMMENTS_EDITEDBY,@COMMENTS_CANCELEDBY,
...
CREATE TABLE LABEVENTS 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "LABEVENTS"                                                    */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\LABEVENTS.csv' INTO TABLE LABEVENTS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE MICROBIOLOGYEVENTS 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "MICROBIOLOGYEVENTS"                                           */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\MICROBIOLOGYEVENTS.csv' INTO TABLE MICROBIOLOGYEVENTS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
   (@ROW_ID,@SUBJECT_ID,@HADM_ID,@CHARTDATE,@CHARTTIME,@SPEC_ITEMID,@SPEC_TYPE_DESC,@ORG_ITEMID,@ORG_NAME,@ISOLATE_NUM,@AB_ITEMID,@AB_NAME,
...
CREATE TABLE NOTEEVENTS 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "NOTEEVENTS"                                                   */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\NOTEEVENTS.csv' INTO TABLE NOTEEVENTS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE OUTPUTEVENTS 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "OUTPUTEVENTS"                                                 */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\OUTPUTEVENTS.csv' INTO TABLE OUTPUTEVENTS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE PATIENTS 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "PATIENTS"                                                     */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\PATIENTS.csv' INTO TABLE PATIENTS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE PRESCRIPTIONS 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "PRESCRIPTIONS"                                                */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\PRESCRIPTIONS.csv' INTO TABLE PRESCRIPTIONS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE PROCEDUREEVENTS_MV 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "PROCEDUREEVENTS_MV"                                           */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\PROCEDUREEVENTS_MV.csv' INTO TABLE PROCEDUREEVENTS_MV
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE PROCEDURES_ICD 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "PROCEDURES_ICD"                                               */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\PROCEDURES_ICD.csv' INTO TABLE PROCEDURES_ICD
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
   (@ROW_ID,@SUBJECT_ID,@HADM_ID,@SEQ_NUM,@ICD9_CODE)
...
CREATE TABLE SERVICES 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "SERVICES"                                                     */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\SERVICES.csv' INTO TABLE SERVICES
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
CREATE TABLE TRANSFERS 
  ...
  CHARACTER SET = utf8mb4;
/* ---------------------------------------------------------------------------------------*/
/* Carga de datos en tabla "TRANSFERS"                                                    */
/* ---------------------------------------------------------------------------------------*/
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\TRANSFERS.csv' INTO TABLE TRANSFERS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
